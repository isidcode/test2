...
const Img = ({ url, caption }) => {
  return (
    <div>
      <img src={url} className="w-full rounded-lg" alt="blog content" />
...
const BlogContent = ({ block }) => {
  ...
  if (type === "header") {
    if (data.level === 3) return <h3 className="text-3xl font-bold" dangerouslySetInnerHTML={{ __html: data.text }}></h3>
  ...
  return <h1>Block Not Handled</h1>
}
